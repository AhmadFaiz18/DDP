...
#Soal 1
#Melanjutkan Logika Praktikum minggu kemarin mengenai berat badan ideal
#dengan menggunakan If else elif dan input BB

#Soal 2
#Mencari nilai negatif dan positif menggunakan if else dan input nilai
#yang nilai yang integer mau floating 

#Soal 3
#Games batu,gunting kertas if else elif dan input
